/****************************************************************************************
 Luz Automática
  ...
  Activa o desactiva una salida digital (Led,Relay,etc) dependiendo del nivel de intensidad de luz presente en el sensor
...
uint16_t Lux_noche=20; //por debajo de este valor se enciende el foco
uint16_t Lux_dia=30;  //por encima de este valor se apaga el
